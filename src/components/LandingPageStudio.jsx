...
export const LandingPageStudio = () => {
    return (
            ...
            <div className="div">
                ...
                <div className="hero-headline">
                    <div className="overlap">
                        <img className="dot-ornament" alt="Dot ornament" src="dot-ornament.png" />
                        <div className="CTA-contact-now">
                            <div className="text-wrapper-8">Contact Now</div>
                        </div>
                    </div>
                    ...
                    <h1 className="h-1">A Digital Product Agency</h1>
                    <p className="p">
                ...
                <div className="our-client">
                    <p className="text-wrapper-9">Several selected clients, who already believe in our service.</p>
                    <div className="text-wrapper-10">Our Client</div>
                ...
                <div className="how-can-we-help">
                    <div className="overlap-2">
                        ...
                        <div className="group">
                            <img className="dot" alt="Dot" src="dot.png" />
                            <img className="img" alt="Dot" src="image.png" />
                        </div>
